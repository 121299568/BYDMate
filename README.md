...
### Камера слепых зон на приборке

<img src="docs/screenshots/blindspot-cluster.jpg" alt="Левая камера на приборке при включённом левом поворотнике" width="800">

*Левый поворотник: картинка с левой камеры на приборной панели*
...
**3.** В BYDMate откройте **Настройки → Дисплей** и включите тумблер «Проекция на приборку». Приложение само активирует нужный сервис (требуется выполненная активация ADB при установке, см. «Установка»), вручную ничего настраивать не надо.
...
<img src="docs/screenshots/blindspot-cluster.jpg" alt="Камера слепых зон на приборке" width="800">
...
Тот же набор данных, что уходит в ABRP, можно дополнительно отправлять на свой сервер: смотрите вебхук телеметрии в Настройки → Интеграции.
